...
class AccountSessionLoginStartRequest(BaseModel):
    model_config = ConfigDict(
        populate_by_name=True,
    )
    id: RequestId
    method: Annotated[
        Literal["accountSession/login/start"],
        Field(title="AccountSession/login/startRequestMethod"),
    ]
    params: LoginAccountParams
...
class ClientRequest(
    RootModel[
        ...
        | AccountSessionLoginStartRequest
